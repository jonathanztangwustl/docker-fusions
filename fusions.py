...
rois.strand_x = rois.strand_x.str.replace('+', '0', regex = True)
rois.strand_x = rois.strand_x.str.replace('-', '1', regex = True)
rois.strand_y = rois.strand_y.str.replace('+', '0', regex = True)
rois.strand_y = rois.strand_y.str.replace('-', '1', regex = True)
...
supp_align_df.strand2 = supp_align_df.strand2.str.replace('+', '0', regex = True)
supp_align_df.strand2 = supp_align_df.strand2.str.replace('-', '1', regex = True)
